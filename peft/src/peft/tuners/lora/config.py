...
class LoraConfig(PeftConfig):
    ...
    adapter_name: str = field(default="lora", metadata={"help": "Adapter Name either 'lora' or 'polar'"})
    parameterize_S: str = field(default="identity", metadata={"help": "How to parameterize S in case of PoLAR."})
